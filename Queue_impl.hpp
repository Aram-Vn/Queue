...
my::Queue<T>::Queue(const Queue& other)
    : m_end{ other.m_end }, m_cap{ other.m_cap }, m_start{ other.m_start }, m_ptr{ new T[m_cap] }
{
...
my::Queue<T>::Queue(Queue&& other) noexcept
    : m_end{ other.m_end }, m_cap{ other.m_cap }, m_start{ other.m_start }, m_ptr{ other.m_ptr }
{
    other.m_end = 0;
    other.m_cap = 0;
    other.m_start = 0;
